  ...
  const translations = {
    "pt-BR": {
      ...
      careers: {
        ...
        readyMessage:
          "Cadastro validado. O envio será habilitado assim que o canal comercial oficial for conectado.",
    ...
    en: {
      ...
      careers: {
        ...
        readyMessage:
          "Application validated. Sending will be enabled when the official sales channel is connected.",
    ...
    es: {
      ...
      careers: {
        ...
        readyMessage:
          "Registro validado. El envío se habilitará cuando se conecte el canal comercial oficial.",
